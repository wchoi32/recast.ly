var VideoListEntry = (props) => (
  ...
  <div className="video-list-entry media">
    ...
    <div className="media-body">
      <div className="video-list-entry-title" onClick={ () => { props.onVideoClick(props); }}> {props.video.snippet.title} </div>
...
//     </div>
//     <div className="media-body">
//       <div className="video-list-entry-title">{this.props.children.snippet.title}</div>
